...
<html>
    <head>
        ...
        <title>Find A Residence - Ολοκλήρωση Εγγραφής</title>	
    </head>
    <body> 
        <%
        ...
        <div class="onepcssgrid-1200">
            ...
            <div class="onerow">
                <div class="col2"></div>
                <div class="col8">
                    <p>Η εγγραφή σας έχει ολοκληρωθεί με επιτυχία!<br> 
                        Ο λογαριασμός σας θα ενεργοποιηθεί μέσα στις επόμενες 24 ώρες από
                        τους διαχειρηστές της ιστοσελίδας!</p>
                    <p>
