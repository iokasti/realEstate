...
<html>
    <head>
        ...
        <title>Find A Residence - Λάθος Στοιχεία</title>	
    </head>
    <body> 
        <%
        ...
        <div class="onepcssgrid-1200">
            ...
            <div class="onerow">
                <div class="col2"></div>
                <div class="col8">
                    <p>Ο κωδικός που εισάγατε είναι λανθασμένος ή δεν έχετε εγγραφεί στο σύστημά μας. <br>
